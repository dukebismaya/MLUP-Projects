...
## Action Learning (AL) (MCA)
- [AL 01 - Array Operations Using Numpy](MCA/al1.ipynb)
- [AL 02 - Pandas Practical](MCA/al2.ipynb)
- [AL 03 - Matplotlib Practical](MCA/al3.ipynb)
- [AL 04 - Complete Seaborn Iris visualization dashboard](MCA/al4.ipynb)
- [AL 05 - Dash Practicals](MCA/al5.ipynb)
- [AL 06 - Scatterplot with Color and Size](MCA/al6.ipynb)
- [AL 07 - Multiple Lines in One Chart](MCA/al7.ipynb)
- [AL 08 - Histogram Practicals](MCA/al8.ipynb)
- [AL 09 - Bar Chart with Multiple Series](MCA/al9.ipynb)
- [AL 10 - Bubble Chart Practicals](MCA/al10.ipynb)
